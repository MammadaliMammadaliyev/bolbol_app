...
const newMarksWrapper = document.querySelector(".marks_new");
const showAllMarks = document.querySelector("#showAllMarks");
const afterMarksSelected = document.querySelector(".afterMarksSelected");
