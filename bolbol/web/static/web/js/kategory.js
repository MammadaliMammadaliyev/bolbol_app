...
const openSubNav = document.querySelector("#openKatBurger");
...
if (openSubNav) {
  openSubNav.addEventListener("click", () => {
    document.querySelector(".subcategories-nav").classList.toggle("dnone");
    console.log("test");
  });
}
document.querySelector("#openKatBurgerNav").addEventListener("click", () => {
  document.querySelector(".kat_burger").classList.add("kat_burger_visible");
  disableScroll();
});
// document.querySelector(".additional_chekings_item").addEventListener("click", () => {
//   document.querySelector(".subcategories-nav").classList.remove("dnone");
//   console.log("test")
//   // disableScroll();
// });
